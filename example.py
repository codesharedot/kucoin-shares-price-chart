...
r  = requests.get("https://coinmarketcap.com/currencies/crypto-com-coin/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('crypto-com-coin price from 2014')
