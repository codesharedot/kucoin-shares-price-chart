...
r  = requests.get("https://coinmarketcap.com/currencies/kucoin-shares/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('kucoin-shares price from 2014')
