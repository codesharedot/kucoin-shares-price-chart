...
r  = requests.get("https://coinmarketcap.com/currencies/unus-sed-leo/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('unus-sed-leo price from 2014')
