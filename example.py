...
r  = requests.get("https://coinmarketcap.com/currencies/huobi-token/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('huobi-token price from 2014')
