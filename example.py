...
r  = requests.get("https://coinmarketcap.com/currencies/bitcoin-gold/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('bitcoin-gold price from 2014')
