...
r  = requests.get("https://coinmarketcap.com/currencies/ethereum-classic/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('ethereum-classic price from 2014')
